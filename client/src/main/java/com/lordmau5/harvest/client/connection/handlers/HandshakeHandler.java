package com.lordmau5.harvest.client.connection.handlers;

import com.lordmau5.harvest.client.Client;
import com.lordmau5.harvest.client.connection.NetworkHandler;
import com.lordmau5.harvest.client.connection.ServerConnection;
import com.lordmau5.harvest.network.codec.CodecRegistry;
import com.lordmau5.harvest.network.codec.PacketCodec;
import com.lordmau5.harvest.network.packet.handshake.PacketClientHandshake;
import com.lordmau5.harvest.network.packet.handshake.PacketCloseConnection;
import com.lordmau5.harvest.network.packet.handshake.PacketServerHandshake;
